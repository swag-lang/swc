...
This file is the product backlog for sSnapForge, measured against the capture tools it competes
...
## Where sSnapForge already stands
...
These application-specific leads will be fixed under `bin/apps/modules/sSnapForge`.
