...
public:
    ...
    void emitSanityUndefined(MicroReg addrReg, uint64_t sizeInBytes);
    ...
    void emitOpTernaryRegRegRegImm(MicroReg regDst, MicroReg regSrc1, MicroReg regSrc2, uint8_t value, MicroOp op, MicroOpBits opBits);
