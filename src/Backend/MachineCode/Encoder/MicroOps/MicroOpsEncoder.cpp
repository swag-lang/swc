...
EncodeResult MicroOpsEncoder::encodeLoadSymbolRelocAddress(CpuReg reg, uint32_t symbolIndex, uint32_t offset, EmitFlags emitFlags)
{
    ...
    inst.operands[1].valueU64 = symbolIndex;
    inst.operands[2].valueU64 = offset;
...
EncodeResult MicroOpsEncoder::encodeLoadSymRelocValue(CpuReg reg, uint32_t symbolIndex, uint32_t offset, CpuOpBits opBits, EmitFlags emitFlags)
{
    ...
    inst.operands[2].valueU64  = symbolIndex;
    inst.operands[3].valueU64  = offset;
    return EncodeResult::Zero;
}
...
EncodeResult MicroOpsEncoder::encodeJumpTable(CpuReg tableReg, CpuReg offsetReg, int32_t currentIp, uint32_t offsetTable, uint32_t numEntries, EmitFlags emitFlags)
{
    ...
    inst.operands[2].valueU64 = currentIp;
    inst.operands[3].valueU64 = offsetTable;
    inst.operands[4].valueU64 = numEntries;
    return EncodeResult::Zero;
}
...
EncodeResult MicroOpsEncoder::encodePatchJump(const CpuJump& jump, uint64_t offsetDestination, EmitFlags emitFlags)
{
    ...
    inst.operands[0].valueU64 = jump.offsetStart;
    inst.operands[1].valueU64 = offsetDestination;
    inst.operands[2].valueU64 = 1;
    return EncodeResult::Zero;
}
...
EncodeResult MicroOpsEncoder::encodeLoadRegMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, CpuOpBits opBits, EmitFlags emitFlags)
{
    ...
    inst.operands[3].valueU64  = memOffset;
    return EncodeResult::Zero;
}
...
EncodeResult MicroOpsEncoder::encodeLoadRegImm(CpuReg reg, uint64_t value, CpuOpBits opBits, EmitFlags emitFlags)
{
    ...
    inst.operands[0].reg    = reg;
    inst.operands[1].opBits = opBits;
    inst.operands[2].valueU64  = value;
    return EncodeResult::Zero;
}
...
EncodeResult MicroOpsEncoder::encodeLoadSignedExtendRegMem(CpuReg reg, CpuReg memReg, uint64_t memOffset, CpuOpBits numBitsDst, CpuOpBits numBitsSrc, EmitFlags emitFlags)
{
    ...
    inst.operands[4].valueU64  = memOffset;
    return EncodeResult::Zero;
}
...
EncodeResult MicroOpsEncoder::encodeLoadAmcRegMem(CpuReg regDst, CpuOpBits opBitsDst, CpuReg regBase, CpuReg regMul, uint64_t mulValue, uint64_t addValue, CpuOpBits opBitsSrc, EmitFlags emitFlags)
{
    ...
    inst.operands[5].valueU64  = mulValue;
    inst.operands[6].valueU64  = addValue;
    return EncodeResult::Zero;
}
...
EncodeResult MicroOpsEncoder::encodeLoadAmcMemImm(CpuReg regBase, CpuReg regMul, uint64_t mulValue, uint64_t addValue, CpuOpBits opBitsBaseMul, uint64_t value, CpuOpBits opBitsValue, EmitFlags emitFlags)
{
    ...
    inst.operands[5].valueU64  = mulValue;
    inst.operands[6].valueU64  = addValue;
    inst.operands[7].valueU64  = value;
    return EncodeResult::Zero;
}
...
EncodeResult MicroOpsEncoder::encodeLoadMemImm(CpuReg memReg, uint64_t memOffset, uint64_t value, CpuOpBits opBits, EmitFlags emitFlags)
{
    ...
    inst.operands[0].reg    = memReg;
    inst.operands[1].opBits = opBits;
    inst.operands[2].valueU64  = memOffset;
    inst.operands[3].valueU64  = value;
    return EncodeResult::Zero;
}
...
EncodeResult MicroOpsEncoder::encodeOpBinaryMemImm(CpuReg memReg, uint64_t memOffset, uint64_t value, CpuOp op, CpuOpBits opBits, EmitFlags emitFlags)
{
    ...
    inst.operands[2].cpuOp  = op;
    inst.operands[3].valueU64  = memOffset;
    inst.operands[4].valueU64  = value;
    return EncodeResult::Zero;
}
...
void MicroOpsEncoder::processEncoding(Encoder& encoder, const MicroInstruction& inst, size_t idx)
{
    switch (inst.op)
    {
        case MicroOp::End:
        ...
        case MicroOp::SymbolRelocAddr:
            encoder.encodeLoadSymbolRelocAddress(inst.operands[0].reg, static_cast<uint32_t>(inst.operands[1].valueU64), static_cast<uint32_t>(inst.operands[2].valueU64), inst.emitFlags);
            break;
        case MicroOp::SymbolRelocValue:
            encoder.encodeLoadSymRelocValue(inst.operands[0].reg, static_cast<uint32_t>(inst.operands[2].valueU64), static_cast<uint32_t>(inst.operands[3].valueU64), inst.operands[1].opBits, inst.emitFlags);
            break;
        case MicroOp::Push:
        ...
        case MicroOp::JumpTable:
            encoder.encodeJumpTable(inst.operands[0].reg, inst.operands[1].reg, static_cast<int32_t>(inst.operands[2].valueU64), static_cast<uint32_t>(inst.operands[3].valueU64), static_cast<uint32_t>(inst.operands[4].valueU64), inst.emitFlags);
            break;
        ...
        {
            const size_t jumpIndex = resolveJumpIndex(inst.operands[0].valueU64);
            SWC_ASSERT(jumpIndex < jumpValid_.size());
            SWC_ASSERT(jumpValid_[jumpIndex]);
            if (inst.operands[2].valueU64 == 1)
                encoder.encodePatchJump(jumps_[jumpIndex], inst.operands[1].valueU64, inst.emitFlags);
            else
        ...
        case MicroOp::JumpCondI:
        {
            ...
            encoder.encodePatchJump(jump, inst.operands[2].valueU64, inst.emitFlags);
            break;
        }
        case MicroOp::JumpM:
        ...
        case MicroOp::LoadRR:
            ...
            break;
        case MicroOp::LoadRI:
            encoder.encodeLoadRegImm(inst.operands[0].reg, inst.operands[2].valueU64, inst.operands[1].opBits, inst.emitFlags);
            break;
        case MicroOp::LoadRM:
            encoder.encodeLoadRegMem(inst.operands[0].reg, inst.operands[1].reg, inst.operands[3].valueU64, inst.operands[2].opBits, inst.emitFlags);
            break;
        case MicroOp::LoadSignedExtRM:
            encoder.encodeLoadSignedExtendRegMem(inst.operands[0].reg, inst.operands[1].reg, inst.operands[4].valueU64, inst.operands[2].opBits, inst.operands[3].opBits, inst.emitFlags);
            break;
        ...
        case MicroOp::LoadZeroExtRM:
            encoder.encodeLoadZeroExtendRegMem(inst.operands[0].reg, inst.operands[1].reg, inst.operands[4].valueU64, inst.operands[2].opBits, inst.operands[3].opBits, inst.emitFlags);
            break;
        ...
        case MicroOp::LoadAddrRM:
            encoder.encodeLoadAddressRegMem(inst.operands[0].reg, inst.operands[1].reg, inst.operands[3].valueU64, inst.operands[2].opBits, inst.emitFlags);
            break;
        case MicroOp::LoadAmcMR:
            encoder.encodeLoadAmcMemReg(inst.operands[0].reg, inst.operands[1].reg, inst.operands[5].valueU64, inst.operands[6].valueU64, inst.operands[3].opBits, inst.operands[2].reg, inst.operands[4].opBits, inst.emitFlags);
            break;
        case MicroOp::LoadAmcMI:
            encoder.encodeLoadAmcMemImm(inst.operands[0].reg, inst.operands[1].reg, inst.operands[5].valueU64, inst.operands[6].valueU64, inst.operands[3].opBits, inst.operands[7].valueU64, inst.operands[4].opBits, inst.emitFlags);
            break;
        case MicroOp::LoadAmcRM:
            encoder.encodeLoadAmcRegMem(inst.operands[0].reg, inst.operands[3].opBits, inst.operands[1].reg, inst.operands[2].reg, inst.operands[5].valueU64, inst.operands[6].valueU64, inst.operands[4].opBits, inst.emitFlags);
            break;
        case MicroOp::LoadAddrAmcRM:
            encoder.encodeLoadAddressAmcRegMem(inst.operands[0].reg, inst.operands[3].opBits, inst.operands[1].reg, inst.operands[2].reg, inst.operands[5].valueU64, inst.operands[6].valueU64, inst.operands[4].opBits, inst.emitFlags);
            break;
        case MicroOp::LoadMR:
            encoder.encodeLoadMemReg(inst.operands[0].reg, inst.operands[3].valueU64, inst.operands[1].reg, inst.operands[2].opBits, inst.emitFlags);
            break;
        case MicroOp::LoadMI:
            encoder.encodeLoadMemImm(inst.operands[0].reg, inst.operands[2].valueU64, inst.operands[3].valueU64, inst.operands[1].opBits, inst.emitFlags);
            break;
        case MicroOp::CmpRR:
            encoder.encodeCmpRegReg(inst.operands[0].reg, inst.operands[1].reg, inst.operands[2].opBits, inst.emitFlags);
            break;
        case MicroOp::CmpRI:
            encoder.encodeCmpRegImm(inst.operands[0].reg, inst.operands[2].valueU64, inst.operands[1].opBits, inst.emitFlags);
            break;
        case MicroOp::CmpMR:
            encoder.encodeCmpMemReg(inst.operands[0].reg, inst.operands[3].valueU64, inst.operands[1].reg, inst.operands[2].opBits, inst.emitFlags);
            break;
        case MicroOp::CmpMI:
            encoder.encodeCmpMemImm(inst.operands[0].reg, inst.operands[2].valueU64, inst.operands[3].valueU64, inst.operands[1].opBits, inst.emitFlags);
            break;
        ...
        case MicroOp::OpUnaryM:
            encoder.encodeOpUnaryMem(inst.operands[0].reg, inst.operands[3].valueU64, inst.operands[2].cpuOp, inst.operands[1].opBits, inst.emitFlags);
            break;
        ...
        case MicroOp::OpBinaryMR:
            encoder.encodeOpBinaryMemReg(inst.operands[0].reg, inst.operands[4].valueU64, inst.operands[1].reg, inst.operands[3].cpuOp, inst.operands[2].opBits, inst.emitFlags);
            break;
        case MicroOp::OpBinaryRI:
            encoder.encodeOpBinaryRegImm(inst.operands[0].reg, inst.operands[3].valueU64, inst.operands[2].cpuOp, inst.operands[1].opBits, inst.emitFlags);
            break;
        case MicroOp::OpBinaryMI:
            encoder.encodeOpBinaryMemImm(inst.operands[0].reg, inst.operands[3].valueU64, inst.operands[4].valueU64, inst.operands[2].cpuOp, inst.operands[1].opBits, inst.emitFlags);
            break;
        case MicroOp::OpBinaryRM:
            encoder.encodeOpBinaryRegMem(inst.operands[0].reg, inst.operands[1].reg, inst.operands[4].valueU64, inst.operands[3].cpuOp, inst.operands[2].opBits, inst.emitFlags);
            break;
...
void MicroOpsEncoder::encode(Encoder& encoder)
{
    ...
    for (size_t idx = 0; idx < instructions_.size(); ++idx)
    {
        ...
        if (inst.op == MicroOp::End)
            break;
        processEncoding(encoder, inst, idx);
    }
}
