...
private:
    ...
    void encodeCallLocal(Symbol* targetSymbol, CallConvKind callConv, EncodeFlags emitFlags) override;
    void encodeCallExtern(Symbol* targetSymbol, uint64_t targetAddress, CallConvKind callConv, EncodeFlags emitFlags) override;
