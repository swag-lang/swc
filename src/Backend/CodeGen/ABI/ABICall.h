...
namespace ABICall
{
    ...
    void     callByLocal(MicroInstrBuilder& builder, CallConvKind callConvKind, IdentifierRef symbolName, uint64_t targetAddress, uint32_t numPreparedArgs, const Return& ret, Symbol* callDebugSymbol = nullptr);
    ...
    void     callByLocal(MicroInstrBuilder& builder, CallConvKind callConvKind, IdentifierRef symbolName, uint64_t targetAddress, uint32_t numPreparedArgs, Symbol* callDebugSymbol = nullptr);
