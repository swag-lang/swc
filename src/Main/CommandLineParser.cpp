    ...
    global_(&global)
{
    ...
    addArg(HelpOptionGroup::Target, "build run test", "--backend-kind", nullptr, CommandLineType::EnumString, &cmdLine_->backendKindName, "exe|dll|lib", "Select the native artifact kind generated by the native backend.");
    ...
    addArg(HelpOptionGroup::Target, "build run test", "--name", nullptr, CommandLineType::String, &cmdLine_->name, nullptr, "Set the artifact name.");
    addArg(HelpOptionGroup::Target, "build run test", "--out-dir", nullptr, CommandLineType::Path, &cmdLine_->outDir, nullptr, "Set the artifact output directory.");
    addArg(HelpOptionGroup::Target, "build run test", "--work-dir", nullptr, CommandLineType::Path, &cmdLine_->workDir, nullptr, "Set the work directory.");
