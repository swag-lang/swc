...
import common;
immutable u64 MSGSIZE = 8388608;
immutable u64 M32  = 0xFFFFFFFFUL;

immutable u64[64] KTAB = [
...
int main()
{
    ...
    u64 nb        = MSGSIZE;
    u8* buf       = cast(u8*) xalloc(MSGSIZE + 128);
