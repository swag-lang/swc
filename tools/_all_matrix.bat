...
call "%TOOLS_DIR%_suite.bat" test %EXE% --cfg release --no-optimize %EXTRA%
call "%TOOLS_DIR%_suite.bat" test %EXE% --cfg release --optimize %EXTRA%
...
call "%TOOLS_DIR%_suite.bat" test %EXE% --cfg debug --no-optimize %EXTRA%
call "%TOOLS_DIR%_suite.bat" test %EXE% --cfg debug --optimize %EXTRA%
...
call "%TOOLS_DIR%_suite.bat" test %EXE% --cfg fast-debug --no-optimize %EXTRA%
call "%TOOLS_DIR%_suite.bat" test %EXE% --cfg fast-debug --optimize %EXTRA%
...
call "%TOOLS_DIR%_suite.bat" test %EXE% --cfg fast-compile --no-optimize %EXTRA%
call "%TOOLS_DIR%_suite.bat" test %EXE% --cfg fast-compile --optimize %EXTRA%
