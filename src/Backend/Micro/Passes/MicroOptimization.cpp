...
bool MicroOptimization::isTerminatorInstruction(const MicroInstr& inst)
{
    switch (inst.op)
    {
...
bool MicroOptimization::isSameRegisterClass(MicroReg leftReg, MicroReg rightReg)
{
...
bool MicroOptimization::isLocalDataflowBarrier(const MicroInstr& inst, const MicroInstrUseDef& useDef)
{
