...
bool MicroDeadCodeEliminationPass::canCurrentDefKillPreviousPureDef(const MicroInstr& inst, const MicroInstrOperand* ops, const MicroReg defReg)
{
    if (!ops)
        return false;
...
bool MicroDeadCodeEliminationPass::isPureDefCandidate(const MicroInstr& inst, const MicroInstrUseDef& useDef, const Encoder* encoder, const CallConvKind callConvKind)
{
...
void MicroDeadCodeEliminationPass::transferInstructionLiveness(std::unordered_set<MicroReg>&       outLiveIn,
