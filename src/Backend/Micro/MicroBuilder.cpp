...
namespace
{
    ...
    uint64_t computeControlFlowHash(const MicroStorage& storage, const MicroOperandStorage& operands)
    {
...
const MicroControlFlowGraph& MicroBuilder::controlFlowGraph()
{
    ...
    if (hasControlFlowGraph_ && controlFlowGraphStorageRevision_ == storageRevision)
    {
        ...
        const uint64_t hash = computeControlFlowHash(instructions_, operands_);
    ...
    controlFlowGraphHash_            = computeControlFlowHash(instructions_, operands_);
