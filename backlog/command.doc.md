...
### command.doc.001 — Code examples in documentation are rendered, never compiled
...
### command.doc.002 — Search stops at the page it is printed in
...
### command.doc.003 — There is no serializable documentation model
...
- Related: command.doc.004, command.doc.005

### command.doc.004 — No public-API diff consumes the documentation model

Once command.doc.003 publishes stable item identities and signatures, compare two serialized models and
report source-compatible additions, removals, and changes without scraping HTML.

- Related: command.doc.003

### command.doc.005 — No documentation-coverage report
...
- Related: command.doc.003, command.doc.004
...
### command.doc.006 — A documentation run spends nine tenths of its time re-running sema
