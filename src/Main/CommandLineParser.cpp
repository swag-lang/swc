    ...
    global_(&global)
{
    ...
    addArg(HelpOptionGroup::Target, "test", "--name", nullptr, CommandLineType::String, &cmdLine_->name, nullptr, "Set the artifact name.");
    addArg(HelpOptionGroup::Target, "test", "--out-dir", nullptr, CommandLineType::Path, &cmdLine_->outDir, nullptr, "Set the artifact output directory.");
    addArg(HelpOptionGroup::Target, "test", "--work-dir", nullptr, CommandLineType::Path, &cmdLine_->workDir, nullptr, "Set the work directory.");
