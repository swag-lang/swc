# sFileScope Text Viewer Backlog

This backlog covers the sFileScope adapters and application-owned behavior of the basic text,
code, subtitle, table, diff, and log viewers. Markdown and HTML integration lives in
[filescope.document.md](filescope.document.md); engine work owned by `std/gui` remains in
...
- Next: expose the parsed cue track as navigation landmarks and add a compact time ruler.
