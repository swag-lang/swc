...
private:
    ...
    const Token& tok() const { return *SWC_CHECK_NOT_NULL(curToken_); }
    ...
    TokenRef ref() const
    {
        TokenRef result = static_cast<TokenRef>(static_cast<uint32_t>(curToken_ - firstToken_));
