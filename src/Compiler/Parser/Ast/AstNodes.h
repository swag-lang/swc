...
struct AstNamedNodeT : AstNodeT<I, E>
{
    ...
    explicit AstNamedNodeT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
};
...
struct AstCompoundT : AstNodeT<I, E>
{
    ...
    explicit AstCompoundT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
...
struct AstLambdaExprT : AstNodeT<I, E>
{
    ...
    explicit AstLambdaExprT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
...
struct AstBinaryT : AstNodeT<I, E>
{
    ...
    explicit AstBinaryT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
...
{
    explicit AstLiteralT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
};
...
struct AstAggregateDeclT : AstNodeT<I, E>
{
    ...
    explicit AstAggregateDeclT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
...
struct AstAnonymousAggregateDeclT : AstNodeT<I, E>
{
    ...
    explicit AstAnonymousAggregateDeclT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
...
struct AstIfBaseT : AstNodeT<I, E>
{
    ...
    explicit AstIfBaseT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
...
struct AstIntrinsicInitDropCopyMoveT : AstNodeT<I, E>
{
    ...
    explicit AstIntrinsicInitDropCopyMoveT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
...
{
    explicit AstInternalCallZeroT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
};
...
struct AstInternalCallUnaryT : AstNodeT<I, E>
{
    ...
    explicit AstInternalCallUnaryT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
...
struct AstInternalCallBinaryT : AstNodeT<I, E>
{
    ...
    explicit AstInternalCallBinaryT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
...
struct AstInternalCallTernaryT : AstNodeT<I, E>
{
    ...
    explicit AstInternalCallTernaryT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
...
struct AstGenericParamT : AstNodeT<I, E>
{
    ...
    explicit AstGenericParamT(SourceLocation loc) :
        AstNodeT<I, E>(loc)
    {
    }
