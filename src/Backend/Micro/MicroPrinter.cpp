...
#undef SWC_MICRO_INSTR_DEF
    ...
    std::string_view microOpName(MicroOp op)
    {
        switch (op)
        {
            ...
            case MicroOp::VecXor:
                return "vec.xor";
            case MicroOp::VecAdd8:
                return "vec.add8";
            case MicroOp::VecAdd16:
                return "vec.add16";
            case MicroOp::VecAdd64:
                return "vec.add64";
            case MicroOp::VecSub8:
                return "vec.sub8";
            case MicroOp::VecSub16:
                return "vec.sub16";
            case MicroOp::VecSub64:
                return "vec.sub64";
            case MicroOp::VecMul16:
                return "vec.mul16";
            ...
            case MicroOp::VecSatAddS16:
                return "vec.satadds16";
            case MicroOp::VecSatAddU8:
                return "vec.sataddu8";
            case MicroOp::VecSatAddU16:
                return "vec.sataddu16";
            case MicroOp::VecSatSubS8:
                return "vec.satsubs8";
            case MicroOp::VecSatSubS16:
                return "vec.satsubs16";
            case MicroOp::VecSatSubU8:
                return "vec.satsubu8";
            case MicroOp::VecSatSubU16:
                return "vec.satsubu16";
            case MicroOp::VecAvgU8:
                return "vec.avgu8";
            case MicroOp::VecAvgU16:
                return "vec.avgu16";
            ...
            case MicroOp::VecMinS8:
                return "vec.mins8";
            case MicroOp::VecMinS16:
                return "vec.mins16";
            case MicroOp::VecMinS32:
                return "vec.mins32";
            case MicroOp::VecMinU8:
                return "vec.minu8";
            case MicroOp::VecMinU16:
                return "vec.minu16";
            case MicroOp::VecMinU32:
                return "vec.minu32";
            case MicroOp::VecMaxS8:
                return "vec.maxs8";
            case MicroOp::VecMaxS16:
                return "vec.maxs16";
            case MicroOp::VecMaxS32:
                return "vec.maxs32";
            case MicroOp::VecMaxU8:
                return "vec.maxu8";
            case MicroOp::VecMaxU16:
                return "vec.maxu16";
            case MicroOp::VecMaxU32:
                return "vec.maxu32";
            case MicroOp::VecCmpEq8:
                return "vec.cmpeq8";
            case MicroOp::VecCmpEq16:
                return "vec.cmpeq16";
            case MicroOp::VecCmpEq32:
                return "vec.cmpeq32";
            case MicroOp::VecCmpEq64:
                return "vec.cmpeq64";
            case MicroOp::VecCmpGtS8:
                return "vec.cmpgts8";
            case MicroOp::VecCmpGtS16:
                return "vec.cmpgts16";
            case MicroOp::VecCmpGtS32:
                return "vec.cmpgts32";
            case MicroOp::VecCmpGtS64:
                return "vec.cmpgts64";
            case MicroOp::VecPackSS16:
                return "vec.packss16";
            case MicroOp::VecPackSS32:
                return "vec.packss32";
            case MicroOp::VecPackUS16:
                return "vec.packus16";
            case MicroOp::VecPackUS32:
                return "vec.packus32";
            case MicroOp::VecUnpackLo8:
                return "vec.unpacklo8";
            case MicroOp::VecUnpackLo16:
                return "vec.unpacklo16";
            case MicroOp::VecUnpackLo32:
                return "vec.unpacklo32";
            case MicroOp::VecUnpackLo64:
                return "vec.unpacklo64";
            case MicroOp::VecUnpackHi8:
                return "vec.unpackhi8";
            case MicroOp::VecUnpackHi16:
                return "vec.unpackhi16";
            case MicroOp::VecUnpackHi32:
                return "vec.unpackhi32";
            case MicroOp::VecUnpackHi64:
            ...
            case MicroOp::VecAddF64:
                return "vec.addf64";
            case MicroOp::VecSubF32:
                return "vec.subf32";
            case MicroOp::VecSubF64:
                return "vec.subf64";
            case MicroOp::VecMulF32:
                return "vec.mulf32";
            case MicroOp::VecMulF64:
                return "vec.mulf64";
            case MicroOp::VecDivF32:
                return "vec.divf32";
            case MicroOp::VecDivF64:
                return "vec.divf64";
            case MicroOp::VecMinF32:
                return "vec.minf32";
            case MicroOp::VecMinF64:
                return "vec.minf64";
            case MicroOp::VecMaxF32:
                return "vec.maxf32";
            case MicroOp::VecMaxF64:
                return "vec.maxf64";
            ...
            case MicroOp::VecMoveMaskF32:
                return "vec.movemaskf32";
            case MicroOp::VecMoveMaskF64:
                return "vec.movemaskf64";
            ...
            case MicroOp::VecShiftRightBytes:
                return "vec.shrbytes";
            case MicroOp::VecRoundF32:
                return "vec.roundf32";
            case MicroOp::VecRoundF64:
                return "vec.roundf64";
            case MicroOp::VecCmpF32:
                return "vec.cmpf32";
    ...
    Utf8 naturalInstruction(const MicroInstr& inst, const MicroInstrOperand* ops, MicroRegPrintMode regPrintMode, const Encoder* encoder, std::string_view relocValue)
    {
        switch (inst.op)
        {
            ...
            {
                const auto lhs = regName(ops[0].reg, regPrintMode, encoder);
                const auto rhs = memAmcString(ops[1].reg, ops[2].reg, ops[5].valueU64, ops[6].valueU64, regPrintMode, encoder);
            ...
            case MicroInstrOpcode::TestRegReg:
                return std::format("{}({}, {})", tagInstructionToken("test"), regName(ops[0].reg, regPrintMode, encoder), regName(ops[1].reg, regPrintMode, encoder));
            case MicroInstrOpcode::TestRegImm:
                return std::format("{}({}, {})", tagInstructionToken("test"), regName(ops[0].reg, regPrintMode, encoder), hexU64(ops[2].valueU64));
            ...
            case MicroInstrOpcode::CmpRegAmc:
                return std::format("{}({}, {})", tagInstructionToken("cmp"), regName(ops[0].reg, regPrintMode, encoder), memAmcString(ops[1].reg, ops[2].reg, ops[5].valueU64, ops[6].valueU64, regPrintMode, encoder));
...
Utf8 MicroPrinter::format(const TaskContext& ctx, const MicroStorage& instructions, const MicroOperandStorage& operands, MicroRegPrintMode regPrintMode, const Encoder* encoder, const MicroBuilder* builder)
{
    ...
    for (auto it = view.begin(); it != view.end(); ++it)
    {
        ...
        switch (inst.op)
        {
            ...
            case MicroInstrOpcode::LoadRegImm:
            case MicroInstrOpcode::LoadRegPtrImm:
                appendRegImmBits(out, ctx, ops, 0, 1, 2, regPrintMode, encoder, false);
                break;
