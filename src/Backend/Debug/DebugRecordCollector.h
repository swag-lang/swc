...
// both describe the program identically. With debug information disabled, collects only the linkage
// names and machine code needed for unwind sections. Call only after code generation is complete; it reads stable
// compiler/backend state and writes only to the provided output collector.
