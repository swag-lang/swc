...
The creation callback receives only `FileViewer.Host`. Create the document below
...
evolution. It must compare `FileViewer.ViewerApiVersion` before invoking a descriptor callback; the
