...
decided there — [T-426](pixel.md#t-426--jpeg-chroma-sampling-is-limited-to-one-block-per-unit)
...
- What the emitted code says is left, and it is not a source shape:
  [F-190](optimization.md#f-190--a-short-branching-function-spills-with-the-whole-register-file-free).
...
- What that says about where the gap is, and it is not one thing:
  ...
  - **Where that leaves the work, in order**: closing the backend's 2.2x is worth more than
    ...
    [F-195](optimization.md#f-195--a-loop-header-drops-every-mapping-and-the-register-to-fix-it-is-already-spoken-for).
