...
void MicroBuilder::emitVecShuffleRegRegImm(MicroReg regDst, MicroReg regSrc, uint8_t control, MicroOpBits opBits)
{
    const auto&        inst = addInstruction(MicroInstrOpcode::VecShuffleRegRegImm, 4);
    MicroInstrOperand* ops  = inst.ops(operands_);
    ops[0].reg              = regDst;
    ops[1].reg              = regSrc;
    ops[2].opBits           = opBits;
...
void MicroBuilder::emitVecGatherS32(MicroReg regDst, MicroReg baseReg, MicroReg indicesReg)
{
    const auto&        inst = addInstruction(MicroInstrOpcode::VecGatherS32, 3);
    MicroInstrOperand* ops  = inst.ops(operands_);
    ops[0].reg              = regDst;
    ops[1].reg              = baseReg;
...
{
    const auto&        inst = addInstruction(MicroInstrOpcode::OpBinaryRegRegReg, 5);
    MicroInstrOperand* ops  = inst.ops(operands_);
    ops[0].reg              = regDst;
    ops[1].reg              = regSrc1;
    ops[2].reg              = regSrc2;
