    ...
    global_(&global)
{
    ...
    addArg(HelpOptionGroup::Target, "build run", "--backend-kind", nullptr, CommandLineType::EnumString, &cmdLine_->backendKindName, "exe|dll|lib", "Select the native artifact kind generated by the native backend.");
