...
| File | Area | Updated |
| --- | --- | --- |
| [std.gui.html.md](std.gui.html.md) | The HTML engine behind `Gui.HtmlView` | 2026-09-15 07:52 |
| [compiler.core.md](compiler.core.md) | Compiler frontend, backend, incrementality, services, and workspace build engine | 2026-09-14 10:43 |
| [compiler.safety.md](compiler.safety.md) | Memory safety: the borrow rules, the sanity proofs, the runtime guards, and the unsafe surface | 2026-09-14 06:26 |
| [compiler.optimization.md](compiler.optimization.md) | Backend optimization passes, register allocation, and generated-code performance | 2026-09-14 06:25 |
...
| [app.scope.document.md](app.scope.document.md) | The Swag Scope Markdown, HTML, PDF, office-document, and ebook viewers | 2026-09-12 06:10 |
...
The repository test tool checks new working-tree identifiers against `HEAD` and the checked-out
branch's historical suffixes. Run it before committing new entries; it rejects a retired suffix
and a gap above the historical maximum. Stage domain renames so Git can identify the old path;
the check follows that file's history to retain reservations made under earlier names.
Existing historical identity conflicts still need an audit.
