...
| 415, 416 | Double free, use after free | **Proven** through fields, elements, casts and wrappers, and through ownership: a type declaring `opDrop` states no copy; aliases and conditional frees are must-analysis misses by design |
