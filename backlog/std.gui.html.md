...
### std.gui.html.021 — The HTML box build allocates one heap String per word of the document
...
### std.gui.html.022 — A streaming rebuild re-parses every stylesheet from scratch
