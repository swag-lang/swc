...
void MicroInstrBuilder::encodeLoadRegPtrImm(MicroReg reg, uint64_t value, ConstantRef constantRef, Symbol* targetSymbol, IdentifierRef symbolName, EncodeFlags emitFlags)
{
