...
This file is the product roadmap for sSnapForge, measured against the capture tools it competes
...
[findings.snapforge.md](findings.snapforge.md), platform leads in
