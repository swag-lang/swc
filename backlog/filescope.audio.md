# sFileScope Audio Viewer Backlog
...
### B-106 — Audio playback has no speed or pitch policy
...
### B-107 — Audio cannot loop a selection or mark an A/B region
...
### B-108 — The waveform cannot zoom, pan, or navigate precisely
...
### B-109 — Audio has no markers, chapters, cue-sheet, or navigation history
...
### B-110 — Audio channels cannot be isolated, mixed, or compared
...
### B-111 — Audio has no spectrogram or frequency probe
...
### B-112 — Audio has no loudness, peak, clipping, silence, or DC analysis
...
### B-113 — Tags, artwork, codec/container facts, and ReplayGain are hidden
...
- Next: define an audio metadata model separate from decoded samples and surface it through B-046.
...
### B-114 — Lossy codec delay and gapless playback cannot be verified
...
### B-115 — Output device, format conversion, and device loss are invisible
