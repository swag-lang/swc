...
namespace
{
    ...
    Result emitIndexBoundCheck(CodeGen& codeGen, AstNodeRef indexRef, const TypeInfo& indexedType, const CodeGenNodePayload& indexedPayload, MicroReg indexReg)
    {
    ...
    CodeGenNodePayload emitIndexAddress(CodeGen& codeGen, AstNodeRef indexRef, const TypeInfo& indexedType, const CodeGenNodePayload& indexedPayload, TypeRef resultTypeRef)
    {
        ...
        SWC_INTERNAL_CHECK(emitIndexBoundCheck(codeGen, indexRef, indexedType, indexedPayload, indexReg) == Result::Continue);
