...
void MicroEmitPass::encodeInstruction(const MicroPassContext& context, MicroInstrRef instructionRef, const MicroInstr& inst)
{
    ...
    switch (inst.op)
    {
        ...
        case MicroInstrOpcode::LoadRegTlsSlot:
            encoder.encodeLoadRegTlsSlot(ops[0].reg, ops[1].reg);
            break;
        ...
        case MicroInstrOpcode::VecUnaryAmcRegMem:
            encoder.encodeVecUnaryAmcRegMem(ops[0].reg, ops[1].reg, ops[2].reg, ops[5].valueU64, ops[6].valueU64, ops[4].opBits, ops[7].microOp, ops[3].opBits);
            break;
        ...
        case MicroInstrOpcode::VecShuffleRegRegImm:
            encoder.encodeVecShuffleRegRegImm(ops[0].reg, ops[1].reg, ops[3].valueU64, ops[2].opBits);
            break;
        case MicroInstrOpcode::VecGatherS32:
            encoder.encodeVecGatherS32(ops[0].reg, ops[1].reg, ops[2].reg);
            break;
        ...
        case MicroInstrOpcode::LoadHighByteRegReg:
            encoder.encodeLoadHighByteRegReg(ops[0].reg, ops[1].reg);
            break;
        ...
        case MicroInstrOpcode::LoadZeroExtAmcRegMem:
            encoder.encodeLoadZeroExtendAmcRegMem(ops[0].reg, ops[1].reg, ops[2].reg, ops[5].valueU64, ops[6].valueU64, ops[3].opBits, ops[4].opBits);
            break;
        ...
        case MicroInstrOpcode::TestRegImm:
            encoder.encodeTestRegImm(ops[0].reg, ops[2].immediateValue(getNumBits(ops[1].opBits)), ops[1].opBits);
            break;
        ...
        case MicroInstrOpcode::CmpAmcReg:
            encoder.encodeCmpAmcReg(ops[0].reg, ops[1].reg, ops[5].valueU64, ops[6].valueU64, ops[2].reg, ops[4].opBits);
            break;
        case MicroInstrOpcode::CmpRegAmc:
            encoder.encodeCmpRegAmc(ops[0].reg, ops[1].reg, ops[2].reg, ops[5].valueU64, ops[6].valueU64, ops[3].opBits);
            break;
        ...
        case MicroInstrOpcode::OpBinaryAmcMemImm:
            encoder.encodeOpBinaryAmcMemImm(ops[0].reg, ops[1].reg, ops[4].valueU64, ops[5].valueU64, ops[6].immediateValue(getNumBits(ops[2].opBits)), ops[7].microOp, ops[2].opBits);
            break;
