...
- Follow [../write-swag-compiler-messages/SKILL.md](../write-swag-compiler-messages/SKILL.md)
  ...
  for validation (`tools/manage-reference-workspace.bat dm test` must stay green).
...
A syntax change is done only when: the compiler accepts the new form, `manage-reference-workspace.bat dm test`
