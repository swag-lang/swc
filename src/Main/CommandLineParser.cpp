    ...
    global_(&global)
{
    ...
    addArg(HelpOptionGroup::Target, "test", "--backend-kind", nullptr, CommandLineType::EnumString, &cmdLine_->backendKindName, "exe|dll|lib", "Select the native artifact kind generated by the test backend.");
