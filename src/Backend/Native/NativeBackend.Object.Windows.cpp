...
namespace NativeBackendDetail
{
    ...
    private:
        ...
        bool appendSingleCodeRelocation(const uint32_t functionOffset, const MicroRelocation& relocation, CoffSectionBuild& textSection)
        {
        ...
        static void writeU64(std::vector<std::byte>& bytes, const uint32_t offset, const uint64_t value)
        {
