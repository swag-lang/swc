...
<?php include('common/start-head.php'); ?><title>Contribute-tests</title>
...
<div class="code-block"><span class="SCde">$ swag new -w:myWorkspace --test
</span></div>
<p>This will also create a test module <span class="code-inline">myWorkspace</span> located in <span class="code-inline">myWorkspace\tests</span>.</p>
<p>You can then compile and run the tests with the <span class="code-inline">test</span> command.</p>
<div class="code-block"><span class="SCde">$ swag test -w:myWorkspace
</span></div>
...
<li><span class="code-inline">swag\bin\testsuite</span> is the official test suite for Swag. If your test module is cool, then it could ultimately find a place there.</li>
